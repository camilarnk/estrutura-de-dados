...
9.	Maior Valor: Implemente uma função que navegue pela árvore e retorne o maior valor
nela contido (Dica: onde costumam ficar os maiores valores em uma árvore binária de busca?).
...
int buscarMaiorValor(Nodo *n) {
	
	if(n->dir == NULL) 
		return n->valor;
	
	return buscarMaiorValor(n->dir);
...
int main(void) {  	
	...
	printf("\nMaior valor da arvore: %d", buscarMaiorValor(raiz));
